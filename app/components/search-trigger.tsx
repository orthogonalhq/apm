  ...
  return (
    <>
      <button
        ...
        className={`flex items-center gap-2 bg-white/[0.04] border border-white/[0.08] rounded-lg px-3 py-1.5 text-xs t-meta hover:border-white/[0.14] hover:bg-white/[0.06] transition-all cursor-text ${className}`}
      >
        <svg
          className="h-3.5 w-3.5 shrink-0 t-ghost"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
